...
```{r,glm_caret, incLude = FALSE, warning= FALSE, message = FALSE}
...
)$statistics$Accuracy # We use model 1 as it has a slight higher accuracy and uses lesser coefficients
